      ...
      <section className="relative pt-36 pb-32 md:pt-48 md:pb-40 px-6 bg-[#020817]">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white tracking-tight leading-[1.05] mb-6 font-syne">
            Ai Soluion technologies Technologies
          </h1>
          ...
          <p className="text-lg text-slate-400 max-w-3xl mx-auto leading-relaxed font-light">
            Ai Soluion technologies Technologies is a pioneering IT solutions company specialising in advanced artificial intelligence technologies. We are dedicated to transforming businesses through innovative AI solutions that enhance operational efficiency and drive intelligent decision-making.
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-7 space-y-12">
            <div>
              ...
              <p className="text-slate-600 leading-relaxed font-light mb-6 text-lg">
                Rania Jamil Choudhury leads Ai Soluion technologies Technologies' strategic direction, growth, and international expansion. With deep expertise across AI, data, enterprise technology, and digital transformation, she has positioned Ai Soluion technologies Technologies as a trusted partner for government and enterprise clients seeking secure, scalable, and intelligent solutions.
              </p>
              <p className="text-slate-600 leading-relaxed font-light text-lg">
                Her vision is to build more than a technology company. She is creating a platform-led business that helps organisations move from fragmented systems to integrated, AI-powered operations. Through Cortex Intell, Ai Soluion technologies Technologies is developing intelligent platforms that connect data, decisions, and automation to support the future of high-performing and autonomous enterprises.
              </p>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-lg max-w-2xl mx-auto mb-10 font-light">
              Join the 56,000+ companies utilizing Ai Soluion technologies Technologies to streamline operations and dominate their sectors globally.
            </p>
