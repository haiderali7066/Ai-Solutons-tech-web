...
export default function CreateBlogPage() {
  ...
  const createBlog = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.refresh(); // Ensure the dashboard picks up the new post
    } catch (err) {
      console.error(err);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 border-b border-black/10 pb-6">
          ...
          <p className="text-black/60 mt-2">
            Draft, edit, and publish a new article.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-black/10 p-6 shadow-sm sticky top-6">
                <h3 className="font-bold text-lg mb-4 border-b border-black/10 pb-2">Publish</h3>
                ...
                >
                  ...
                  {loading ? "Saving Blog..." : "Upload Blog Post"}
                </button>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-black/10 p-6 shadow-sm">
                ...
                {/* Hidden file input wrapped in a custom styled label */}
