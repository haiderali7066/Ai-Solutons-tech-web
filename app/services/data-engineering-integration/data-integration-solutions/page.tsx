...
export const metadata = {
  title: 'Data Integration Solutions & Architecture | AI Solution Technologies',
  description: 'Unify your enterprise data landscape. Build resilient, scalable, and automated data pipelines connecting on-premise and cloud systems.',
};
...
══════════════════════════════════════ */
const problems = [
  'Siloed data scattered across legacy and cloud systems',
  'Nightly batch jobs fail silently, causing reporting errors',
  'Costly point-to-point API spaghetti that breaks constantly',
  'High latency making real-time decision-making impossible',
  'Inconsistent data formats leading to poor data quality',
  'Vendor lock-in with inflexible legacy ETL tools',
];

const deliverables = [
  'Modern ELT/ETL architecture design (Medallion Architecture)',
  'Real-time streaming & event-driven integration',
  'Azure Data Factory / Databricks / Snowflake implementation',
  'API Gateway & Microservices data layer setup',
  'Automated data quality & validation checks',
  'Zero-downtime database migration strategies',
  'Centralized logging, alerting, and CI/CD pipelines',
  'Data engineering team upskilling & handover',
];

const industries = ['Retail & E-commerce', 'Financial Services', 'Manufacturing', 'Logistics', 'Healthcare', 'Energy'];
const roles = ['VP of Data Engineering', 'Chief Data Officer', 'Enterprise Architect', 'CIO', 'Director of IT'];

/* ══════════════════════════════════════
   MAIN PAGE COMPONENT (100% Server Side)
══════════════════════════════════════ */
export default function DataIntegrationSolutionsPage() {
  return (
    <main className="overflow-hidden bg-[#fafbfe] text-[#0f172a] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#020817]">
          {/* High-quality tech/data integration abstract image */}
          <img 
            src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=2000" 
            alt="Global Network Integration" 
        ...
        <div className="absolute left-[5%] bottom-[15%] w-48 h-48 bg-white/[0.02] border border-white/10 rounded-full backdrop-blur-md p-4 anim-float-delayed hidden lg:flex items-center justify-center shadow-2xl">
          ...
          <GitMerge className="absolute w-8 h-8 text-white/50" />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            ...
            <span className="block mt-3 bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent pb-2">
              — breaking down silos forever.
            </span>
          </h1>

          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Stop relying on brittle point-to-point scripts. We build resilient, automated data pipelines that securely sync your on-premise legacy systems with modern cloud infrastructure.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Most integration projects fail because they rely on fragile scripts that break with every source update. We architect robust, automated pipelines that <strong className="font-black text-blue-600 relative inline-block">transform chaotic data silos into a single, reliable stream of truth<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> — scaling securely from gigabytes to petabytes."
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              ...
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A massive global retailer was struggling with 15 disconnected regional ERP and POS systems. We designed an automated Medallion architecture on Databricks, pulling everything into a unified data cloud. Business units now have governed, analytics-ready data at their fingertips.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    99.9% <RefreshCcw className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Pipeline Uptime</div>
                  <div className="text-slate-500 text-sm mt-1">with automated CI/CD checks</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    10x <Zap className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Faster Availability</div>
                  <div className="text-slate-500 text-sm mt-1">transitioning from batch to stream</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm h-full">
                ...
                <p className="text-slate-500 text-sm font-light">From architecture design to production pipelines</p>
              </div>
            </div>
      ...
      <section className="pb-24 px-6 bg-[#fafbfe]">
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            <span className="text-xs font-bold tracking-widest text-blue-200 uppercase mb-4 block">Strategic Architecture Advisory</span>
            ...
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll examine your current data architecture, identify bottlenecks, and map out a modern integration strategy — at no cost and no commitment.
            </p>
