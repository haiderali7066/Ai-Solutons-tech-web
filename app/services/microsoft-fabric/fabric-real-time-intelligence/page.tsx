...
export const metadata = {
  title: 'Fabric Real-Time Intelligence | AI Solution Technologies',
  description: 'Process, analyze, and act on streaming telemetry and operational data in milliseconds with Microsoft Fabric Real-Time Intelligence.',
};
...
══════════════════════════════════════ */
const problems = [
  'Batch processing is too slow for operational monitoring',
  'Streaming architectures (Kafka/Spark) require heavy engineering',
  'Alerting systems are disconnected from the actual data source',
  'IoT and telemetry data overwhelm traditional SQL databases',
  'Struggling to join real-time streams with historical batch data',
  'Anomalies in operations are found hours after they occur',
];

const deliverables = [
  'Eventstream ingestion architecture & setup',
  'High-performance KQL (Kusto) database design',
  'Real-time automated alerting via Data Activator',
  'IoT & telemetry data pipeline integration',
  'Seamless OneLake integration for historical lookbacks',
  'Live Power BI dashboard development',
  'Query performance tuning for high-concurrency',
  'Engineering training on KQL and stream processing',
];

const industries = ['Manufacturing', 'Logistics', 'Energy', 'Telecommunications', 'Retail', 'IoT Providers'];
const roles = ['COO', 'VP of Operations', 'Chief Data Officer', 'IoT Director', 'Head of Supply Chain'];

/* ══════════════════════════════════════
   MAIN PAGE COMPONENT (100% Server Side)
══════════════════════════════════════ */
export default function FabricRealTimeIntelligencePage() {
  return (
    <main className="overflow-hidden bg-[#fafbfe] text-[#0f172a] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#020817]">
          {/* Fast-moving data/fiber optic abstract image */}
          <img 
        ...
        <div className="absolute left-[5%] bottom-[15%] w-48 h-48 bg-white/[0.02] border border-white/10 rounded-full backdrop-blur-md p-4 anim-float-delayed hidden lg:flex items-center justify-center shadow-2xl">
          ...
          <Zap className="absolute w-8 h-8 text-white/50" />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            Analyze and act on live telemetry in milliseconds 
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Move from batch reporting to instant operational intelligence. Ingest IoT, logs, and streaming events into Microsoft Fabric for real-time dashboards and automated actions.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Eventstream</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">KQL Database</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Data Activator</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">IoT Hub</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">OneLake</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
            </React.Fragment>
          ))}
        </div>
      ...
      <section className="relative py-24 bg-[#fafbfe]">
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <Radio className="absolute -right-10 -top-10 w-48 h-48 text-slate-50 -rotate-12 transition-transform duration-700 group-hover:rotate-0 group-hover:scale-110 pointer-events-none" />
            
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Most vendors build complex, brittle pipelines that require dedicated engineering teams just to keep streams running. We do the opposite: <strong className="font-black text-blue-600 relative inline-block">stream, analyze, and act on billions of events natively in Fabric<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> — bridging the gap between insight and automated operational action instantly."
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-2/5 relative min-h-[300px] lg:min-h-full bg-slate-900 overflow-hidden">
              <img 
                ...
                alt="Industrial Telemetry Operations" 
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              ...
              <h3 className="text-3xl md:text-4xl font-black text-white font-syne mb-6">
                Manufacturing Telemetry Pipeline
              </h3>
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A regional manufacturing plant struggled with machine downtime. We implemented Fabric Eventstream and KQL Database to ingest sensor data from 1,200 machines. Data Activator now triggers predictive maintenance alerts before critical failures happen.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    2.4M <Activity className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Events Processed</div>
                  <div className="text-slate-500 text-sm mt-1">per minute at peak volume</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    &lt; 1s <Gauge className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">End-to-End Latency</div>
                  <div className="text-slate-500 text-sm mt-1">from sensor to automated alert</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-7 rounded-2xl bg-[#fafbfe] border border-slate-200 p-8 md:p-12 shadow-sm transition-shadow hover:shadow-md">
              <h3 className="text-xl font-bold text-[#020817] mb-10 uppercase tracking-wide flex items-center gap-3">
                <Radio className="w-5 h-5 text-blue-600" /> Who this is for
              </h3>
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              ...
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm">
                ...
                <p className="text-slate-500 text-sm font-light">From event stream ingestion to live dashboards</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight leading-tight mb-6">
              Stop waiting on batch processing.
            </h2>
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll review your telemetry volume, discuss your operational goals, and outline how quickly we can implement a real-time intelligence layer — at no cost and no commitment.
            </p>
