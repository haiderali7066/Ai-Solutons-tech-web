...
const servicesData = [
  ...
  },
  {
    ...
    icon: <Building2 className="w-7 h-7" strokeWidth={1.7} />,
  },
  {
    num: '06',
  ...
  },
  {
    ...
    icon: <GitMerge className="w-7 h-7" strokeWidth={1.7} />,
  },
  {
    num: '08',
  ...
  },
  {
    ...
    icon: <Settings className="w-7 h-7" strokeWidth={1.7} />,
  },
];
