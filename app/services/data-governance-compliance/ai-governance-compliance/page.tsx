...
export const metadata = {
  title: 'Enterprise AI Governance & Compliance | AI Solution Technologies',
  description: 'Deploy enterprise AI safely with robust guardrails, PII redaction, automated audit trails, and strict framework alignment.',
};
...
══════════════════════════════════════ */
const problems = [
  'Employees are using shadow AI tools without corporate IT oversight',
  'High risk of proprietary code or customer PII leaking to public LLMs',
  'Model outputs are prone to hallucinations or unvetted bias',
  'No clear visibility into user prompts, AI costs, or model performance',
  'Uncertainty around matching AI workflows with global regulations (EU AI Act, NIST)',
  'Inability to audit or trace how an automated AI decision was made',
];

const deliverables = [
  'Enterprise AI risk assessment & strategy blueprint',
  'Real-time LLM gateway implementation for strict prompt controls',
  'Automated PII masking and sensitive data tokenization',
  'Regulatory compliance mapping (ISO 42001, NIST AI RMF, EU AI Act)',
  'Explainable AI (XAI) models with complete input/output lineages',
  'Centralized AI usage, cost, and toxic content monitoring dashboards',
  'Model bias, drift, and performance drift guardrails',
  'Corporate Responsible AI policy formulation & training',
];

const industries = ['Financial Services', 'Healthcare', 'Insurance', 'Legal Operations', 'Government', 'Defense'];
const roles = ['Chief Compliance Officer', 'General Counsel', 'Chief AI Officer', 'CDO', 'CIO'];
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#020817]">
          ...
          <img 
            ...
            alt="Secure Cyber Infrastructure" 
        ...
        <div className="absolute right-[5%] top-[20%] w-64 h-40 bg-white/[0.02] border border-white/10 rounded-xl backdrop-blur-md p-4 anim-float hidden lg:block shadow-2xl">
          ...
          <div className="space-y-2">
            <div className="w-full h-3 bg-emerald-500/10 rounded-sm"></div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            Deploy enterprise AI safely with bulletproof governance 
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Innovate aggressively without compromising corporate liability. Build real-time gateway controls, absolute data privacy guardrails, and audit-ready pipelines directly into your architecture.
          </p>
          ...
          <div className="mt-12 flex justify-center">
            ...
            >
              Book a risk review consultation
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">ISO 42001</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">NIST AI RMF</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">EU AI Act</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">PII Redaction</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">LLM Firewalls</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
            </React.Fragment>
          ))}
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Most organizations build AI capabilities first and look for vulnerabilities after a security incident. We do the opposite: <strong className="font-black text-blue-600 relative inline-block">wrap your enterprise models in strict governance filters<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> — logging prompts, blocking exposure, and enforcing safety so the board can scale AI initiatives with complete confidence."
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              <FileCheck className="w-16 h-16 text-blue-500/10 absolute right-10 top-10 transform group-hover:rotate-12 transition-transform duration-500" />
              <h3 className="text-3xl md:text-4xl font-black text-white font-syne mb-6">
                Healthcare & Insurance Guardrail Deployment
              </h3>
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A regional healthcare and insurance provider deployed our central AI compliance framework across 12 distinct internal departments. The legal and security teams can now intercept internal PII leaks in real-time while strictly fulfilling automated regulatory audits.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    100% <Lock className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">PII Leaks Intercepted</div>
                  <div className="text-slate-500 text-sm mt-1">at the proxy gateway line</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    Auditable <CheckCircle2 className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Model Decisions</div>
                  <div className="text-slate-500 text-sm mt-1">logged automatically with citations</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              ...
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm">
                ...
                <p className="text-slate-500 text-sm font-light">From policy discovery to enterprise guardrail enforcement</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll outline an immediate risk footprint roadmap, protect your core IP assets, and show you exactly what an enterprise governance architecture looks like — completely risk-free.
            </p>
