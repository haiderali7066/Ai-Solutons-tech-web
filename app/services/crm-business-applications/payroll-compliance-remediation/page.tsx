...
export const metadata = {
  title: 'AI Payroll Compliance & Remediation | AI Solution Technologies',
  description: 'Audit, identify, and remediate complex payroll compliance errors across years of historical workforce data autonomously with absolute mathematical traceabilities.',
};
...
══════════════════════════════════════ */
const problems = [
  'Complex labor awards or enterprise agreements are chronically misinterpreted',
  'Historical underpayments or overpayments surfacing during external audits',
  'Manual checking of multi-year timesheets takes months of expensive analyst labor',
  'Imminent risk of regulatory fines, interest penalties, and class actions',
  'Fragmented data silos across legacy rosters, biometric clocks, and payroll engines',
  'HR and Legal teams overwhelmed trying to quantify liability exposure accurately',
];

const deliverables = [
  'Multi-source data parsing (Biometric Clocks, Rosters, Legacy Payroll Logs)',
  'AI award interpretation & enterprise agreement rule ingestion',
  'Automated variance engine (Comparing historical payouts vs lawful entitlements)',
  'Individual-level remediation ledger generation for back-pay accuracy',
  'Regulator-ready transparency reports with exhaustive line-by-line trails',
  'Conversational AI console for Legal and HR compliance interrogations',
  'Proactive real-time payroll anomaly monitoring anomalies pre-payout',
  'Executive risk mitigation and strategic legal handover advisory',
];

const industries = ['Retail & Hospitality', 'Healthcare & Aged Care', 'Manufacturing', 'Mining & Resources', 'Logistics & Supply Chain', 'Government & Education'];
const roles = ['Chief People Officer', 'HR Director', 'General Counsel', 'CFO', 'Head of Global Payroll'];

/* ══════════════════════════════════════
   MAIN PAGE COMPONENT (100% Server Side)
══════════════════════════════════════ */
export default function AIPayrollCompliancePage() {
  return (
    <main className="overflow-hidden bg-[#fafbfe] text-[#0f172a] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#020817]">
          {/* High-quality compliance/legal workforce abstract image */}
          <img 
            src="https://images.unsplash.com/photo-1450133064473-71024230f91b?auto=format&fit=crop&q=80&w=2000" 
            alt="Workforce Compliance Audit" 
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            AI Historical Payroll Audit & Remediation
            <span className="block mt-3 bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent pb-2">
              — perfect traceabilities, zero manual error.
            </span>
          </h1>

          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Ingest thousands of complex employment rules, timesheets, and rosters autonomously. Quantify past variances, map calculations precisely to the minute, and ringfence liability instantly.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Workday Workforce</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">SAP SuccessFactors</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">UKG Dimensions / Kronos</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">ADP Global Payroll</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Employment Hero</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
            </React.Fragment>
          ))}
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Traditional consulting firms deploy armies of junior accountants to pass spreadsheets around for 18 months. We do the opposite: <strong className="font-black text-blue-600 relative inline-block">deploy an enterprise AI engine directly on raw workforce logs<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> — parsing years of shifting complex labor laws in weeks. Regulators accept our results because every single shift calculation is backed by an unalterable audit trail."
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              <FileText className="w-16 h-16 text-blue-500/10 absolute right-10 top-10 transform group-hover:rotate-12 transition-transform duration-500" />
              ...
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A healthcare group with 14,000+ rostered workers discovered multi-year shift allowance miscalculations due to overlapping modern awards. Our AI engine audited 6 years of biometric clock variants in 4 weeks, calculating down to precise pay brackets and satisfying regulatory compliance deadlines.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    4 Weeks <AlertTriangle className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Processing Time</div>
                  <div className="vs 14-month manual projection">vs 14-month manual estimate</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    100% <CheckCircle2 className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Audit Transparency</div>
                  <div className="text-slate-500 text-sm mt-1">Regulator approved math profiles</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm h-full">
                ...
                <h4 className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em] mb-3">Remediation Delivery Cycle</h4>
                <div className="text-3xl md:text-4xl font-black text-[#020817] font-syne mb-2">12–16 weeks</div>
                <p className="text-slate-500 text-sm font-light">From rule model alignment to verified transaction outputs</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight leading-tight mb-6">
              Protect your enterprise from systemic payroll risk.
            </h2>
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a private 30-minute brief. We will discuss your current enterprise architecture, compliance pain points, and lay out an execution map for AI remediation — strictly confidential.
            </p>
