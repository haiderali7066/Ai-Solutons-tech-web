...
export const metadata = {
  title: 'Enterprise Power Platform Consulting | AI Solution Technologies',
  description: 'Accelerate digital transformation with enterprise-grade Power Platform solutions. Secure apps, hyper-automation, and custom Copilot agents.',
};
...
══════════════════════════════════════ */
const problems = [
  'Manual data entry and paper forms slow down operations',
  'Fragmented "Shadow IT" apps create security and compliance risks',
  'Critical business logic is locked inside broken, fragile spreadsheets',
  'Off-the-shelf software fails to match your unique operational workflows',
  'Field and remote teams lack modern, mobile-friendly applications',
  'Internal automation ideas are completely stalled in long IT backlogs',
];

const deliverables = [
  'Power Platform Center of Excellence (CoE) governance setup',
  'Custom Power Apps development (Canvas & Model-Driven)',
  'End-to-end Power Automate workflow & RPA integration',
  'Custom Copilot Studio AI assistants & conversational agents',
  'Relational data modeling with Microsoft Dataverse',
  'Application Lifecycle Management (ALM) & pipeline creation',
  'Custom data connectors to legacy or third-party systems',
  'Internal citizen developer training & enablement programs',
];

const industries = ['Manufacturing', 'Healthcare', 'Financial Services', 'Professional Services', 'Logistics', 'Retail'];
const roles = ['CIO', 'COO', 'Head of Automation', 'Director of IT', 'VP of Operations'];

/* ══════════════════════════════════════
   MAIN PAGE COMPONENT (100% Server Side)
══════════════════════════════════════ */
export default function PowerPlatformConsultingPage() {
  return (
    <main className="overflow-hidden bg-[#fafbfe] text-[#0f172a] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#020817]">
          {/* High-quality enterprise/automation abstract image */}
          <img 
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            Scale complex workflows with Power Platform
            <span className="block mt-3 bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent pb-2">
              — without fragile code.
            </span>
          </h1>

          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Replace siloed workflows with secure, enterprise-grade low-code solutions. Build custom applications, automate repetitive logic, and embed targeted AI agents tailored entirely to your operations.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Power Apps</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Power Automate</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Copilot Studio</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Dataverse</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Power Pages</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
            </React.Fragment>
          ))}
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Most low-code initiatives transform into ungoverned shadow IT that risks compliance. We do the opposite: <strong className="font-black text-blue-600 relative inline-block">architect unified operational solutions on Dataverse<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> — secure, fully auditable, highly integrated, and complete with enterprise data guardrails built-in from day one."
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-2/5 relative min-h-[300px] lg:min-h-full bg-slate-900 overflow-hidden">
              <img 
                ...
                alt="Operational Collaboration Team" 
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              ...
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A multi-regional logistics company replaced paper-based safety inspection logs and fragmented email approval workflows. We deployed a highly governed Power Apps mobile portal linked directly to custom Power Automate backend logic, accelerating operations instantly.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    14 Days <Zap className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Saved per month</div>
                  <div className="text-slate-500 text-sm mt-1">in manual process bottlenecks</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    100% <CheckCircle2 className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Compliance Audited</div>
                  <div className="text-slate-500 text-sm mt-1">via automated Dataverse history</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              ...
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm">
                ...
                <p className="text-slate-500 text-sm font-light">From initial scoping to automated launch</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight leading-tight mb-6">
              Ready to eliminate internal bottlenecks?
            </h2>
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll audit your current process bottlenecks, evaluate your existing licenses, and map out an enterprise low-code roadmap — at no cost and no commitment.
            </p>
