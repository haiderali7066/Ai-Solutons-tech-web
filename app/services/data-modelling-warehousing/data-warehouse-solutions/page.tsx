...
export const metadata = {
  title: 'Enterprise Data Warehouse Solutions | AI Solution Technologies',
  description: 'Break down data silos. Centralize, govern, and scale your infrastructure with a modern cloud data warehouse optimized for analytics and enterprise AI.',
};
...
══════════════════════════════════════ */
const problems = [
  'Critical enterprise data is trapped in disconnected, isolated silos',
  'Executive dashboards take hours to load or crash completely',
  'Fragile, unmonitored data pipelines break down silently',
  'Different departments report conflicting numbers for the same metric',
  'Skyrocketing cloud compute costs due to unoptimized queries',
  'Data infrastructure is unorganized and unready for AI integration',
];

const deliverables = [
  'Comprehensive data source & current infrastructure assessment',
  'Scalable multi-source ingestion & automated ETL/ELT pipelines',
  'Modern cloud data warehouse setup (Snowflake, BigQuery, Fabric, or Databricks)',
  'Enterprise-grade data modeling (Star Schema, Data Vault 2.0)',
  'Unified semantic layer for clean, cross-department reporting',
  'Automated data quality tracking and anomalous line alerts',
  'Granular security control and governance framework compliance',
  'Internal data engineering team handoff & systems documentation',
];

const industries = ['Supply Chain & Logistics', 'Retail & E-commerce', 'Financial Services', 'Manufacturing', 'Healthcare', 'Energy & Utilities'];
const roles = ['CDO (Chief Data Officer)', 'CIO', 'VP of Analytics', 'Director of Data Engineering', 'CTO'];

/* ══════════════════════════════════════
   MAIN PAGE COMPONENT (100% Server Side)
══════════════════════════════════════ */
export default function DataWarehouseSolutionsPage() {
  return (
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            Modern Cloud Data Warehouse Solutions
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Consolidate your messy transactional systems, ERPs, and operational applications into a lightning-fast, high-performance analytic architecture built for advanced BI and AI readiness.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              ...
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Google BigQuery</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Legacy reporting systems leave analytics teams writing complex patches and struggling with slow compute speeds. We fix the foundation: <strong className="font-black text-blue-600 relative inline-block">engineer an absolute single source of truth data architecture<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> — transforming disorganized production data into rapid, highly structured query systems that business logic teams can immediately depend on."
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-2/5 relative min-h-[300px] lg:min-h-full bg-slate-900 overflow-hidden">
              <img 
                ...
                alt="Complex Server Room Data Processing" 
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              ...
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A massive supply chain logistics firm processing data from over 25 source operations systems and 40TB of history migrated out of failing on-prem legacy databases. We structured a modern Cloud Warehouse optimizing queries across global inventory models.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    90% Drop <HardDrive className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Query Processing Times</div>
                  <div className="text-slate-500 text-sm mt-1">reduced from hours down to seconds</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    45% Saved <CheckCircle2 className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Compute Infrastructure Cost</div>
                  <div className="text-slate-500 text-sm mt-1">saved yearly via server optimization</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm h-full">
                ...
                <p className="text-slate-500 text-sm font-light">From deep system exploration to full pipeline staging</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight leading-tight mb-6">
              Ready to construct a reliable enterprise data warehouse?
            </h2>
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute architecture conversation. We'll outline data storage scaling parameters, analyze operational friction points, and engineer your engineering blueprint — completely risk-free.
            </p>
