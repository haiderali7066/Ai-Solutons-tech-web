...
export const metadata = {
  title: 'Data Quality Management & Governance | AI Solution Technologies',
  description: 'Turn your data into a trusted asset. End-to-end data quality management, automated profiling, and enterprise governance frameworks.',
};
...
══════════════════════════════════════ */
const problems = [
  'Data is inconsistent across CRM and ERP systems',
  'Decisions are being made on unverified "dark" data',
  'Manual data cleansing consumes hours of team time',
  'Duplicate records causing inflated reporting metrics',
  'Lack of clear data ownership or stewardship',
  'Regulatory compliance and audit failures',
];

const deliverables = [
  'Automated data profiling & anomaly detection',
  'Data quality scoring & monitoring dashboard',
  'Master Data Management (MDM) implementation',
  'Data cleansing & standardization workflows',
  'Governance policy design (roles & responsibilities)',
  'Data cataloging & lineage documentation',
  'Regulatory compliance (GDPR/PII) mapping',
  'Stewardship process training',
];

const industries = ['Financial Services', 'Healthcare', 'Retail', 'Logistics', 'Manufacturing', 'Insurance'];
const roles = ['CDO', 'Data Governance Lead', 'CIO', 'Compliance Officer', 'Head of Data'];

/* ══════════════════════════════════════
   MAIN PAGE COMPONENT (100% Server Side)
══════════════════════════════════════ */
export default function DataQualityServicePage() {
  return (
    <main className="overflow-hidden bg-[#fafbfe] text-[#0f172a] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        <div className="absolute inset-0 z-0 bg-[#020817]">
          <img 
            src="https://images.unsplash.com/photo-1558494949-ef010bbbb317?auto=format&fit=crop&q=80&w=2000" 
            alt="Data Integrity" 
        ...
        <div className="absolute left-[5%] bottom-[15%] w-48 h-48 bg-white/[0.02] border border-white/10 rounded-full backdrop-blur-md p-4 anim-float-delayed hidden lg:flex items-center justify-center shadow-2xl">
          ...
          <FileCheck className="absolute w-8 h-8 text-white/50" />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Stop relying on guesswork. We build the frameworks and automated pipelines to ensure your data is clean, compliant, and ready for analytics or AI.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Data Profiling</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">MDM</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Governance</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Compliance</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Observability</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
            </React.Fragment>
          ))}
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Most companies treat data quality as an IT ticket that gets closed once. We treat it as an <strong className="font-black text-blue-600 relative inline-block">enduring business asset<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong>. We establish automated rules, clear stewardship, and continuous monitoring so your leadership team can finally trust the dashboard metrics they see."
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              <Settings className="w-16 h-16 text-blue-500/10 absolute right-10 top-10 transform group-hover:rotate-12 transition-transform duration-500" />
              <h3 className="text-3xl md:text-4xl font-black text-white font-syne mb-6">
                Data Maturity Uplift
              </h3>
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A regional retailer struggled with mismatched product data across 50+ stores, leading to stock discrepancies. We implemented an MDM solution and automated cleansing rules. Within 3 months, they achieved a single view of inventory, reducing write-offs by 22%.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    22% <Search className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Reduction in write-offs</div>
                  <div className="text-slate-500 text-sm mt-1">via cleansed inventory data</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    100% <CheckCircle2 className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Audit readiness</div>
                  <div className="text-slate-500 text-sm mt-1">on customer records</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm">
                ...
                <div className="text-3xl md:text-4xl font-black text-[#020817] font-syne mb-2">12–20 weeks</div>
                <p className="text-slate-500 text-sm font-light">End-to-end framework and automation deployment</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pb-24 px-6 bg-[#fafbfe]">
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            <span className="text-xs font-bold tracking-widest text-blue-200 uppercase mb-4 block">Data Strategy</span>
            ...
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll look at your current data landscape, discuss your biggest pain points, and outline a roadmap for data maturity — at no cost and no commitment.
            </p>
