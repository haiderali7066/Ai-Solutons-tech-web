...
export const metadata = {
  title: 'Intelligent Master Data Management | AI Solution Technologies',
  description: 'Unify, clean, and govern your critical business data. Establish a single source of truth for customer, product, and vendor data across your enterprise.',
};
...
══════════════════════════════════════ */
const problems = [
  'Customer data is duplicated across CRM, ERP, and billing systems',
  'Product catalogs are inconsistent, causing shipping and pricing errors',
  'No single source of truth for critical vendor and supplier information',
  'Manual data entry causes high error rates and operational bottlenecks',
  'Compliance and privacy risks due to fragmented data governance',
  'AI and analytics initiatives fail because the underlying data is a mess',
];

const deliverables = [
  'Enterprise data architecture and source system assessment',
  'Automated data profiling, cleansing, and deduplication',
  'Implementation of a Golden Record / Single Source of Truth',
  'AI-assisted data matching and survivorship rules',
  'Data governance workflows and stewardship dashboards',
  'Real-time bidirectional sync with core business systems',
  'Data quality monitoring and anomaly detection',
  'Data stewardship team training and handover',
];

const industries = ['Manufacturing', 'Healthcare', 'Retail & CPG', 'Financial Services', 'Supply Chain', 'Telecommunications'];
const roles = ['Chief Data Officer', 'CIO', 'VP of Data & Analytics', 'Head of Master Data', 'Enterprise Architect'];
    ...
    <main className="overflow-hidden bg-[#fafbfe] text-[#0f172a] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#020817]">
          {/* High-quality network/data abstract image */}
          <img 
            src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=2000" 
            alt="Master Data Network" 
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            ...
            <span className="block mt-3 bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent pb-2">
              — your enterprise's single source of truth.
            </span>
          </h1>

          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Eliminate duplicates, resolve conflicts, and unify your critical data assets. We build the governed data foundation required for accurate reporting, operational excellence, and enterprise AI.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              ...
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Informatica</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">SAP MDG</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Profisee</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Most organizations try to build AI and analytics on top of fragmented, messy systems. We do the opposite: <strong className="font-black text-blue-600 relative inline-block">establish a rock-solid single source of truth<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> — unifying customer, product, and vendor data across your entire landscape. You can't have artificial intelligence without intelligent data architecture."
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              ...
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A manufacturing giant (5 ERPs, 12 CRM instances, 50,000+ SKUs) deployed our MDM architecture to unify product and supplier data. By establishing a golden record, they eliminated massive supply chain redundancies and enabled real-time global inventory visibility.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    40% <Activity className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Reduction in duplicates</div>
                  <div className="text-slate-500 text-sm mt-1">across legacy supplier records</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    100% <CheckCircle2 className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Real-time sync</div>
                  <div className="text-slate-500 text-sm mt-1">across core business systems</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm h-full">
                ...
                <p className="text-slate-500 text-sm font-light">From data strategy to golden record deployment</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight leading-tight mb-6">
              Ready to fix your enterprise data foundation?
            </h2>
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll examine your current data fragmentation, discuss your architectural goals, and outline what an MDM engagement would look like — at no cost and no commitment.
            </p>
