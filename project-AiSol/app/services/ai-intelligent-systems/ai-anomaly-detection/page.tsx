...
export const metadata = {
  title: 'AI Anomaly Detection | AI Solution Technologies',
  description: 'Detect fraud, operational faults, and security breaches in real-time. Deploy AI anomaly detection directly on your governed enterprise data streams.',
};
...
══════════════════════════════════════ */
const problems = [
  'Critical faults or fraud are discovered weeks after the fact',
  'Alert fatigue: teams ignore warnings due to 90% false positives',
  'Static rule-based systems miss zero-day anomalies',
  'Root cause analysis takes days of manual log parsing',
  'Millions of data points make human monitoring impossible',
  'Data silos prevent cross-system correlation of threats',
];

const deliverables = [
  'Continuous real-time data ingestion architecture',
  'Unsupervised ML models to establish dynamic baselines',
  'Intelligent alert triage and false-positive reduction',
  'Conversational AI to explain the root cause of the anomaly',
  'Automated remediation or ticketing workflows',
  'Executive monitoring dashboard for enterprise health',
  'Full audit trail of AI detection reasoning',
  'Stakeholder & SOC/NOC team training',
];

const industries = ['FinTech & Banking', 'Manufacturing', 'Cybersecurity', 'Telecommunications', 'Healthcare', 'Energy & Utilities'];
const roles = ['CISO', 'VP of Fraud & Risk', 'COO', 'Head of Operations', 'Chief Data Officer'];
    ...
    <main className="overflow-hidden bg-[#fafbfe] text-[#0f172a] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#020817]">
          {/* High-quality tech/data abstract image */}
          <img 
            src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=2000" 
            alt="Anomaly Detection Data Streams" 
        ...
        <div className="absolute left-[5%] bottom-[15%] w-48 h-48 bg-white/[0.02] border border-white/10 rounded-full backdrop-blur-md p-4 anim-float-delayed hidden lg:flex items-center justify-center shadow-2xl">
          ...
          <div className="absolute w-20 h-20 rounded-full border-4 border-red-500/20 border-b-red-500"></div>
          <Radar className="absolute w-8 h-8 text-white/50" />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            ...
            <span className="block mt-3 bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent pb-2">
              — spot the 0.1% of data that threatens your business.
            </span>
          </h1>

          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Monitor millions of events in real-time. Catch zero-day fraud, predict equipment failure, and eliminate false positives with AI that learns the unique rhythm of your enterprise data.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Splunk</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Datadog</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              ...
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Microsoft Sentinel</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
            </React.Fragment>
          ))}
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Most teams rely on static thresholds, leading to dashboard fatigue where real threats hide among thousands of false alerts. We do the opposite: <strong className="font-black text-blue-600 relative inline-block">deploy adaptive AI that learns your baseline behavior<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> — alerting you only when true anomalies occur, and instantly generating cited root-cause explanations in plain English."
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-2/5 relative min-h-[300px] lg:min-h-full bg-slate-900 overflow-hidden">
              <img 
                src="https://images.unsplash.com/photo-1563986768494-4dee2763ff0f?auto=format&fit=crop&q=80&w=1000" 
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              <AlertTriangle className="w-16 h-16 text-blue-500/10 absolute right-10 top-10 transform group-hover:rotate-12 transition-transform duration-500" />
              ...
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A major payment processor was drowning in 15,000 daily fraud alerts, with a 92% false-positive rate. We deployed an unsupervised anomaly detection model that established dynamic baselines for user behavior. The SOC team now receives fewer than 500 highly-actionable alerts daily, with plain-text AI summaries of exactly why the transaction was flagged.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    60% <Eye className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">False Positive Reduction</div>
                  <div className="text-slate-500 text-sm mt-1">reclaiming 40+ SOC hours weekly</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    $1.2M <CheckCircle2 className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Zero-Day Fraud Blocked</div>
                  <div className="text-slate-500 text-sm mt-1">in the first quarter of deployment</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm h-full">
                ...
                <p className="text-slate-500 text-sm font-light">From data pipeline ingestion to active monitoring</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight leading-tight mb-6">
              Ready to secure your operations with AI?
            </h2>
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll look at your data streams, discuss your current false-positive rates, and outline how an anomaly detection engine can filter the noise — at no cost and no commitment.
            </p>
