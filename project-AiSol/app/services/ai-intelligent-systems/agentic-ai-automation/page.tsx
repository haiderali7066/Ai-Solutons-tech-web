...
export const metadata = {
  title: 'Agentic AI Automation | AI Solution Technologies',
  description: 'Deploy autonomous AI agents that don\'t just answer questions, but reason, adapt, and execute complex multi-step workflows across your enterprise systems.',
};
...
══════════════════════════════════════ */
const problems = [
  'Employees spend hours bridging gaps between disconnected SaaS apps',
  'Traditional RPA bots break every time an application UI changes',
  'Complex workflows stall waiting for human approvals on routine tasks',
  'Scaling operations currently means linearly scaling headcount',
  'Existing automations lack reasoning to handle edge cases or exceptions',
  'Customer support tickets require manual triage and multi-system routing',
];

const deliverables = [
  'Process discovery and agentic suitability assessment',
  'Agent persona design and system prompt engineering',
  'Secure API tool integrations (ERP, CRM, ITSM, Email)',
  'Multi-agent orchestration (planner, executor, reviewer nodes)',
  'Human-in-the-loop (HITL) gateways for critical approvals',
  'Agent memory and context persistence architectures',
  'Real-time execution telemetry and audit logging',
  'Governance framework and enterprise guardrails',
];

const industries = ['Technology & SaaS', 'Healthcare Operations', 'E-commerce', 'Financial Services', 'Supply Chain', 'Customer Support'];
const roles = ['COO', 'Chief AI Officer', 'VP of Operations', 'Head of Automation', 'CIO'];
    ...
    <main className="overflow-hidden bg-[#fafbfe] text-[#0f172a] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#020817]">
          {/* High-quality tech/network abstract image */}
          <img 
        ...
        <div className="absolute left-[5%] bottom-[15%] w-48 h-48 bg-white/[0.02] border border-white/10 rounded-full backdrop-blur-md p-4 anim-float-delayed hidden lg:flex items-center justify-center shadow-2xl">
          ...
          <Bot className="absolute w-8 h-8 text-white/50" />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            ...
            <span className="block mt-3 bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent pb-2">
              — intelligent workflows that execute themselves.
            </span>
          </h1>

          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Deploy autonomous AI agents that reason, adapt to edge cases, and drive complex multi-step processes across your enterprise APIs—while keeping humans in the loop for critical decisions.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              ...
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Microsoft AutoGen</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Azure AI Studio</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Zapier Central</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">UiPath Autopilot</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
            </React.Fragment>
          ))}
        </div>
      ...
      <section className="relative py-24 bg-[#fafbfe]">
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <Workflow className="absolute -right-10 -top-10 w-48 h-48 text-slate-50 -rotate-12 transition-transform duration-700 group-hover:rotate-0 group-hover:scale-110 pointer-events-none" />
            
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Traditional automation tools follow rigid rules and break when the unexpected happens. We do the opposite: <strong className="font-black text-blue-600 relative inline-block">deploy Agentic AI that reasons, adapts, and executes<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> — bridging systems dynamically to solve complex workflows while keeping humans in control of critical approvals."
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-2/5 relative min-h-[300px] lg:min-h-full bg-slate-900 overflow-hidden">
              <img 
                ...
                alt="Technology Dashboard and Team" 
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              ...
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A rapidly scaling enterprise was drowning in complex customer onboarding tasks spanning Jira, Salesforce, and AWS. We deployed an autonomous agent squad to orchestrate provisioning, testing, and client comms. The human touch was reserved solely for relationship building.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    85% <Zap className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Reduction in time</div>
                  <div className="text-slate-500 text-sm mt-1">spent on manual onboarding</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    Zero <CheckCircle2 className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">UI-dependent bot breaks</div>
                  <div className="text-slate-500 text-sm mt-1">thanks to robust API integration</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm h-full">
                ...
                <p className="text-slate-500 text-sm font-light">From process mapping to first autonomous agent live</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll examine your current operational bottlenecks, assess system readiness, and map out a pilot agentic workflow — at no cost and no commitment.
            </p>
