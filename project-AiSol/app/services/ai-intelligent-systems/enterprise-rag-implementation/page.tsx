...
export const metadata = {
  title: 'Enterprise RAG Implementation | AI Solution Technologies',
  description: 'Securely connect LLMs to your private enterprise data. Eliminate hallucinations with highly accurate, role-aware Retrieval-Augmented Generation that cites its sources.',
};
...
══════════════════════════════════════ */
const problems = [
  'Employees spend 20% of their week searching for internal information',
  'Off-the-shelf AI hallucinates because it lacks your business context',
  'Severe security risks from uploading sensitive IP to public ChatGPT',
  'Existing internal search tools are keyword-based and return poor results',
  'Previous AI pilots failed to scale due to low accuracy and trust',
  'Lack of access control (e.g., anyone querying executive compensation)',
];

const deliverables = [
  'Secure, private LLM deployment (Azure OpenAI / AWS Bedrock)',
  'Multi-source ingestion pipeline (SharePoint, Confluence, PDFs, Code)',
  'Enterprise vector database setup & semantic chunking optimization',
  'Role-Based Access Control (RBAC) data filtering',
  'Custom citation engine (every answer links to the exact source)',
  'Conversational Copilot interface for your teams',
  'Continuous hallucination monitoring and evaluation metrics',
  'Prompt engineering training for stakeholders',
];

const industries = ['Legal & Compliance', 'Healthcare & Life Sciences', 'Engineering', 'Financial Services', 'Government', 'Technology'];
const roles = ['CIO', 'CTO', 'Chief AI Officer', 'Head of Knowledge Management', 'VP of Engineering'];
    ...
    <main className="overflow-hidden bg-[#fafbfe] text-[#0f172a] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#020817]">
          {/* High-quality technology/network abstract image */}
          <img 
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            ...
            <span className="block mt-3 bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent pb-2">
              — intelligent AI powered by your secure data.
            </span>
          </h1>

          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Connect Large Language Models securely to your internal documents, wikis, and databases. Eliminate hallucinations with highly accurate, role-aware AI that synthesizes answers and cites its exact sources.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              ...
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">AWS Bedrock</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Pinecone</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">SharePoint & Confluence</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">LangChain</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
            </React.Fragment>
          ))}
        </div>
      ...
      <section className="relative py-24 bg-[#fafbfe]">
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <FileText className="absolute -right-10 -top-10 w-48 h-48 text-slate-50 -rotate-12 transition-transform duration-700 group-hover:rotate-0 group-hover:scale-110 pointer-events-none" />
            
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Standard AI models guess when they don't know the answer. We build Retrieval-Augmented Generation (RAG) systems that act like expert researchers: <strong className="font-black text-blue-600 relative inline-block">searching your secure enterprise data, synthesizing the answer, and citing the exact page and paragraph<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong>. If the information isn't in your data, the AI simply says 'I don't know'."
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-2/5 relative min-h-[300px] lg:min-h-full bg-slate-900 overflow-hidden">
              <img 
                src="https://images.unsplash.com/photo-1505664173696-07514a187008?auto=format&fit=crop&q=80&w=1000" 
                alt="Corporate Enterprise Data Center" 
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              <ShieldCheck className="w-16 h-16 text-blue-500/10 absolute right-10 top-10 transform group-hover:rotate-12 transition-transform duration-500" />
              <h3 className="text-3xl md:text-4xl font-black text-white font-syne mb-6">
                Global Legal & Compliance Firm
              </h3>
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                An international firm with over 2 million historical contracts and compliance guidelines deployed our private RAG architecture. Associates can now ask complex regulatory questions and instantly receive synthesized answers with direct hyperlinks back to the specific clauses in their private repository.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    15 Hours <Clock className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Saved monthly</div>
                  <div className="text-slate-500 text-sm mt-1">per associate on document retrieval</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    Zero <Lock className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Data Leakage</div>
                  <div className="text-slate-500 text-sm mt-1">100% contained inside their tenant</div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm h-full">
                <div className="absolute right-0 bottom-0 opacity-[0.03] group-hover:scale-125 transition-transform duration-700">
                  <Database className="w-40 h-40 -mb-10 -mr-10 text-blue-900" />
                </div>
                ...
                <p className="text-slate-500 text-sm font-light">From infrastructure setup to end-user Copilot rollout</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll discuss your document landscape, evaluate security requirements, and outline a custom RAG architecture plan — at no cost and no commitment.
            </p>
