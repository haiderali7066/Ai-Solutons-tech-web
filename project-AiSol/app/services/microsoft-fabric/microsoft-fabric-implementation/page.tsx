...
export const metadata = {
  title: 'Microsoft Fabric Implementation | AI Solution Technologies',
  description: 'Unify your entire enterprise data estate with Microsoft Fabric. End-to-end implementation from OneLake architecture to DirectLake semantic models.',
};
...
══════════════════════════════════════ */
const problems = [
  'Data is siloed across multiple clouds and disjointed systems',
  'High compute costs from redundant pipelines and duplicated data',
  'Complex, fragmented security and governance models',
  'Delayed reporting and slow Power BI refresh times',
  'Analytics tools (Data Factory, Synapse) operate in isolation',
  'Data isn\'t clean or centralized enough to support enterprise AI',
];

const deliverables = [
  'OneLake architecture & workspace design',
  'Medallion architecture implementation (Bronze, Silver, Gold)',
  'DirectLake semantic model optimization for Power BI',
  'Legacy migration (Synapse, Databricks, SQL to Fabric)',
  'Enterprise-grade security & Purview integration',
  'Fabric capacity planning & cost optimization',
  'Automated CI/CD pipeline setup',
  'Data engineering & stakeholder training',
];

const industries = ['Manufacturing', 'Financial Services', 'Retail', 'Healthcare', 'Government', 'Logistics'];
const roles = ['CDO', 'Chief Data Architect', 'CTO', 'Head of Analytics', 'CFO'];
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            Unify your enterprise data estate with Microsoft Fabric 
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Eliminate data silos. Consolidate Data Factory, Synapse, and Power BI into a single, highly governed SaaS platform. One copy of your data, infinite insights.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              ...
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Data Factory</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Synapse</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Power BI</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Purview</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
            </React.Fragment>
          ))}
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Most organizations patch together disjointed data tools, duplicating data and multiplying costs. We do the opposite: <strong className="font-black text-blue-600 relative inline-block">create a single source of truth in OneLake<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> — consolidating pipelines, engineering, and reporting into a unified platform ready for enterprise AI."
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              ...
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A mid-sized financial institution consolidated their legacy SQL data warehouses and disparate ETL pipelines into Microsoft Fabric. The data team now delivers real-time risk dashboards without duplicating data, vastly lowering Azure compute costs.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    40% <Network className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Reduction in compute cost</div>
                  <div className="text-slate-500 text-sm mt-1">by eliminating redundant ETL</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    Real-time <CheckCircle2 className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">DirectLake Queries</div>
                  <div className="text-slate-500 text-sm mt-1">serving Power BI instantly</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              ...
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm">
                ...
                <p className="text-slate-500 text-sm font-light">From architecture design to production rollout</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll look at your current data architecture, discuss your goals, and outline what a Microsoft Fabric migration would look like — at no cost and no commitment.
            </p>
