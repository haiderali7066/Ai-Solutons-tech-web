...
export const metadata = {
  title: 'Fabric Data Activator & Governance | AI Solution Technologies',
  description: 'Transform passive dashboards into automated actions. Deploy Microsoft Fabric Data Activator with enterprise-grade governance, lineage, and compliance.',
};
...
══════════════════════════════════════ */
const problems = [
  'Data anomalies are caught by humans looking at dashboards',
  'Reaction to supply chain delays takes hours, not seconds',
  'Compliance violations go unnoticed until audit time',
  'Alerting fatigue from uncoordinated, noisy systems',
  'No centralized lineage or governance over data assets',
  'Critical business events slip through the cracks',
];

const deliverables = [
  'Fabric Data Activator (Reflexes) implementation',
  'Microsoft Purview integration for governance',
  'Real-time automated remediation workflows',
  'End-to-end data lineage & catalog mapping',
  'Role-Based Access Control (RBAC) auditing',
  'Custom trigger rules for critical business events',
  'Continuous compliance monitoring',
  'Stakeholder governance training',
];

const industries = ['Financial Services', 'Healthcare', 'Supply Chain', 'Retail', 'Manufacturing', 'Public Sector'];
const roles = ['CDO', 'Data Architect', 'VP of Engineering', 'Compliance Officer', 'COO'];

/* ══════════════════════════════════════
   MAIN PAGE COMPONENT (100% Server Side)
══════════════════════════════════════ */
export default function FabricActivatorGovernancePage() {
  return (
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            Real-time action and bulletproof governance for your data 
            <span className="block mt-3 bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent pb-2">
              — not just passive dashboards.
            </span>
          </h1>

          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            Transform data into automated intelligence. Trigger actions instantly using Microsoft Fabric Data Activator while ensuring strict compliance, lineage, and governance across your entire enterprise estate.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              ...
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Power BI Reflexes</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
      ...
      <section className="relative py-24 bg-[#fafbfe]">
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <BellRing className="absolute -right-10 -top-10 w-48 h-48 text-slate-50 -rotate-12 transition-transform duration-700 group-hover:rotate-0 group-hover:scale-110 pointer-events-none" />
            
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Dashboards are great, but they still require humans to stare at them. We deploy Data Activator to monitor your governed data constantly: <strong className="font-black text-blue-600 relative inline-block">triggering instant actions and alerts the millisecond business conditions change<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> — all while enforcing strict enterprise data governance and lineage."
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              ...
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A massive logistics firm integrated Fabric Data Activator with Purview governance. Their operations team no longer watches delayed Power BI reports; instead, the system automatically reroutes shipments when temperature anomalies hit certain thresholds — fully documented and auditable.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    $1.2M <ShieldCheck className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Spoilage Prevented</div>
                  <div className="text-slate-500 text-sm mt-1">in the first six months</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    Millisec <Zap className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Reaction Time</div>
                  <div className="text-slate-500 text-sm mt-1">from event anomaly to action</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm h-full">
                ...
                <p className="text-slate-500 text-sm font-light">From data assessment to active reflexes</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight leading-tight mb-6">
              Ready to automate actions on your governed data?
            </h2>
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll look at your current Fabric/data setup, discuss your goals, and outline what a Data Activator and Purview engagement would look like — at no cost and no commitment.
            </p>
