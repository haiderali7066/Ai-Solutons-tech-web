...
export const metadata = {
  title: 'Enterprise Data Pipeline Architecture | AI Solution Technologies',
  description: 'Build robust, scalable, and automated data pipelines. Eliminate fragile ETL scripts and deliver trusted, real-time data to your analytics and AI layers.',
};
...
══════════════════════════════════════ */
const problems = [
  'Data teams spend 80% of their time fixing broken pipelines',
  'Nightly batch jobs run into the morning and delay reporting',
  'Data lakes have turned into unmanageable, undocumented swamps',
  'Scaling infrastructure costs are spiraling out of control',
  'Zero visibility into data quality drops or silent failures',
  'ETL processes rely on fragile scripts owned by one person',
];

const deliverables = [
  'Scalable ELT/ETL architecture design & deployment',
  'Modern cloud warehouse/lakehouse setup (Fabric, Snowflake, Databricks)',
  'Automated CI/CD for data engineering workflows',
  'Data quality testing and anomaly detection integration',
  'Orchestration layer implementation (Airflow, dbt, Data Factory)',
  'Real-time streaming & batch processing pipelines',
  'Comprehensive data lineage and technical documentation',
  'Engineering team upskilling & handover',
];

const industries = ['E-commerce', 'Finance', 'Telecommunications', 'Logistics', 'SaaS', 'Media'];
const roles = ['VP of Data', 'Data Engineering Manager', 'CTO', 'Head of Analytics', 'Lead Data Architect'];

/* ══════════════════════════════════════
   MAIN PAGE COMPONENT (100% Server Side)
══════════════════════════════════════ */
export default function DataPipelineArchitecturePage() {
  return (
    <main className="overflow-hidden bg-[#fafbfe] text-[#0f172a] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#020817]">
          {/* High-quality tech/infrastructure abstract image */}
          <img 
        ...
        <div className="absolute right-[5%] top-[20%] w-64 h-40 bg-white/[0.02] border border-white/10 rounded-xl backdrop-blur-md p-4 anim-float hidden lg:block shadow-2xl">
          ...
          <div className="space-y-2">
            ...
            <div className="w-4/5 h-3 bg-indigo-400/20 rounded-sm"></div>
            <div className="w-full h-3 bg-emerald-500/30 rounded-sm"></div>
          </div>
        </div>
        ...
        <div className="absolute left-[5%] bottom-[15%] w-48 h-48 bg-white/[0.02] border border-white/10 rounded-full backdrop-blur-md p-4 anim-float-delayed hidden lg:flex items-center justify-center shadow-2xl">
          ...
          <div className="absolute w-20 h-20 rounded-full border-4 border-indigo-500/20 border-b-indigo-400"></div>
          <Database className="absolute w-8 h-8 text-white/50" />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            Industrial-grade data pipelines built for the enterprise
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-300 font-light">
            We architect and deploy resilient, self-healing data supply chains. Deliver trusted, real-time data to your analytics and AI layers without waking your engineers up at 3 AM.
          </p>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              ...
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">Apache Airflow</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Most companies try to build pipelines with a patchwork of custom code that breaks when source data changes. We do the opposite: <strong className="font-black text-blue-600 relative inline-block">we build automated, modular data supply chains<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong>. Highly observable, completely governed, and designed to scale seamlessly as your data volume explodes."
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-3/5 p-10 md:p-16 relative z-10">
              ...
              <h3 className="text-3xl md:text-4xl font-black text-white font-syne mb-6">
                Global Retail Analytics Scale-up
              </h3>
              <p className="text-lg text-slate-300 leading-relaxed font-light mb-10">
                A multinational retailer (1,200+ stores) replaced a fragile, on-prem legacy ETL process with a modern lakehouse architecture using dbt and Databricks. Data quality testing was embedded in the pipeline, ensuring executives never viewed flawed dashboard metrics again.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    45 Mins <Clock className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Processing Time</div>
                  <div className="text-slate-500 text-sm mt-1">Reduced from 9 hours nightly</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    99.9% <Gauge className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Data Uptime</div>
                  <div className="text-slate-500 text-sm mt-1">With automated self-healing</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-7 rounded-2xl bg-[#fafbfe] border border-slate-200 p-8 md:p-12 shadow-sm transition-shadow hover:shadow-md">
              <h3 className="text-xl font-bold text-[#020817] mb-10 uppercase tracking-wide flex items-center gap-3">
                <Cpu className="w-5 h-5 text-blue-600" /> Who this is for
              </h3>
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm h-full">
                <div className="absolute right-0 bottom-0 opacity-[0.03] group-hover:scale-125 transition-transform duration-700">
                  <Network className="w-40 h-40 -mb-10 -mr-10 text-blue-900" />
                </div>
                ...
                <p className="text-slate-500 text-sm font-light">From architecture blueprint to production deployment</p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-10 font-light">
              Book a 30-minute conversation. We'll review your current data pipelines, discuss your scale bottlenecks, and outline a modern engineering blueprint — at no cost and no commitment.
            </p>
