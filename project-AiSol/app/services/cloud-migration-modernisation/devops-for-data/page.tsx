...
export const metadata = {
  title: 'DevOps for Data (DataOps) | AI Solution Technologies',
  description: 'Automate data pipelines, implement robust CI/CD for data code, and eliminate broken dashboards with production-grade DataOps engineering.',
};
...
const industries = ['Technology & SaaS', 'Financial Services', 'Logistics & Supply Chain', 'E-commerce', 'Healthcare', 'Telecom'];
const roles = ['Chief Data Officer (CDO)', 'Head of Data Engineering', 'VP of Analytics', 'CTO', 'Director of Enterprise Data Platforms'];

/* ══════════════════════════════════════
   MAIN PAGE COMPONENT (100% Server Side)
══════════════════════════════════════ */
export default function DevOpsForDataPage() {
  return (
    <main className="overflow-hidden bg-[#fafbfe] text-[#0f172a] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#020817]">
          {/* High-quality abstract pipeline/network code image */}
          <img 
            src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&q=80&w=2000" 
            alt="Data Pipelines Infrastructure" 
        ...
        <div className="absolute right-[5%] top-[20%] w-64 h-40 bg-white/[0.02] border border-white/10 rounded-xl backdrop-blur-md p-4 anim-float hidden lg:block shadow-2xl">
          <div className="flex items-center gap-3 mb-4 border-b border-white/10 pb-3">
             ...
             <div className="w-2/3 h-2 bg-emerald-500/30 rounded-full flex items-center"><div className="w-1/3 h-full bg-emerald-400 rounded-full"></div></div>
          </div>
          <div className="space-y-2">
            <div className="w-full h-3 bg-blue-500/10 rounded-sm flex items-center px-1"><span className="text-[8px] text-blue-300 font-mono">pipeline_deploy: success</span></div>
            <div className="w-5/6 h-3 bg-slate-500/10 rounded-sm"></div>
            <div className="w-full h-3 bg-indigo-500/20 rounded-sm"></div>
          </div>
        </div>
        ...
        <div className="absolute left-[5%] bottom-[15%] w-48 h-48 bg-white/[0.02] border border-white/10 rounded-full backdrop-blur-md p-4 anim-float-delayed hidden lg:flex items-center justify-center shadow-2xl">
          <div className="w-32 h-32 rounded-full border-4 border-blue-500/20 border-t-indigo-400"></div>
          <div className="absolute w-20 h-20 rounded-full border-4 border-emerald-500/20 border-r-emerald-400"></div>
          <GitBranch className="absolute w-8 h-8 text-white/50" />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white font-syne">
            ...
            <span className="block mt-3 bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent pb-2">
              — software standards for enterprise data.
            </span>
          </h1>
        ...
        <div className="flex gap-16 items-center anim-marquee px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3].map((set) => (
            <React.Fragment key={set}>
              ...
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
              <span className="text-sm font-bold tracking-widest text-slate-600 uppercase">GitHub Actions</span>
              <span className="w-2 h-2 rounded-full bg-blue-500"></span>
            </React.Fragment>
          ))}
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="group rounded-2xl bg-white border border-slate-200 p-10 md:p-14 text-center shadow-[0_10px_40px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-[0_20px_50px_rgba(37,99,235,0.08)]">
            ...
            <p className="relative z-10 text-xl md:text-2xl leading-relaxed text-[#020817] font-light font-syne">
              "Traditional data teams patch up pipelines manually and pray nothing crashes overnight. We build the exact opposite: <strong className="font-black text-blue-600 relative inline-block">fully automated, source-controlled DataOps systems<span className="absolute bottom-0 left-0 w-full h-1 bg-blue-200 -z-10 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span></strong> that isolate bugs, assert testing gates, and execute flawless zero-downtime updates. When a dashboard updates, your engineers know it is flawless because it passed code testing protocols."
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-3xl overflow-hidden bg-[#020817] flex flex-col lg:flex-row border border-slate-800 shadow-2xl relative group">
            ...
            <div className="lg:w-2/5 relative min-h-[300px] lg:min-h-full bg-slate-900 overflow-hidden">
              <img 
                src="https://images.unsplash.com/photo-1600132806370-bf17e65e942f?auto=format&fit=crop&q=80&w=1000" 
                alt="Infrastructure Servers Minimalist" 
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    94% <Activity className="w-5 h-5 text-emerald-400 transform group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Pipeline Failures Eradicated</div>
                  <div className="text-slate-500 text-sm mt-1">thanks to isolated CI check constraints</div>
                </div>
                <div className="group/stat">
                  <div className="text-4xl font-black text-white mb-2 flex items-center gap-2">
                    Minutes <Cpu className="w-5 h-5 text-emerald-400 group-hover/stat:scale-110 transition-transform" />
                  </div>
                  <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">Time-to-Production Deploy</div>
                  <div className="text-slate-500 text-sm mt-1">down from bi-weekly release cycles</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-8">
              <div className="rounded-2xl bg-white border border-slate-200 p-8 flex flex-col justify-center relative overflow-hidden group shadow-sm h-full">
                ...
                <p className="text-slate-500 text-sm font-light">From infrastructure assessment to complete lifecycle automation</p>
              </div>
            </div>
      ...
      <section className="pb-24 px-6 bg-[#fafbfe]">
        <div className="max-w-5xl mx-auto relative bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#3b82f6] rounded-[2.5rem] p-10 sm:p-16 text-center overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.28)]">
          ...
          <div className="relative z-10">
            <span className="text-xs font-bold tracking-widest text-blue-200 uppercase mb-4 block">Infrastructure Advisory</span>
